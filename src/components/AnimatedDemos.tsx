...
import { Settings, Webhook, CheckCircle2, TrendingUp, MousePointer2 } from 'lucide-react';
    ...
    <DemoContainer title="Auto-Escalation Flow">
      <div className="relative w-full h-full p-4">
        ...
        <div className="absolute bottom-2 left-0 right-0 z-20 flex justify-center">
          <div className="text-[9px] font-mono text-slate-400 bg-slate-950 border border-slate-800 px-3 py-1.5 rounded-full flex items-center gap-2 shadow-xl">
